...
public class MainActivity extends AppCompatActivity {
    ...
    private void addDataToFirestore(String courseName, String courseDescription, String courseDuration) {
        ...
        // below method is use to add data to Firebase Firestore. without identifie the document_Id name.
...
// with identifie the name of document.
//        dbCourses.document(courseName).set(courses)
